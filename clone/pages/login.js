        ...
        <section className={styles.background + " min-h-screen flex justify-center items-center"}>
            <div className="main">
                ...
                <form onSubmit={handleLogin} className='flex flex-col gap-4 text-lg mt-5'>
                    ...
                    <input className='bg-r-500 text-white py-2 rounded-lg cursor-pointer' type="submit" value="Login" />
                </form>
                </div>
                <h4 className='text-center text-white pt-3'>New Here? <Link className='font-bold text-red-400' href="/apply">SignIn</Link></h4>
            </div>
        </section>
        <Footer/>
        </>
