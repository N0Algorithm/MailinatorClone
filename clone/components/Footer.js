...
const Footer = () => {
  return (
    <footer>
      <section aria-label="Site Footer" className="bg-r-500 text-white flex flex-col md:flex-row py-3 justify-center items-center">
    ...
    <section aria-label="Site Footer" className=" bg-stone-950 text-white">
        <div className="max-w-screen-xl px-4 py-16 mx-auto space-y-8 sm:px-6 lg:space-y-16 lg:px-8">
          <div className="grid grid-cols-1 gap-8 lg:grid-cols-3">
            <div>
              <div className="text-teal-600">
                <img src='/unnamed.png' className='w-10' alt='typefinance logo'/>Mailinator
              </div>
          ...
          <p className="text-xs text-gray-500">
            NextJS template created by <Link href="/" className="text-gray-500 transition hover:opacity-75">Akshay</Link>
          </p>
        </div>
      </section>
    </footer>
